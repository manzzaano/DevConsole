...
const content = {
  en: {
    ...
    bio3: "Available for remote projects. Former Full Stack Developer at Entreredes (Laravel, PHP, AI model integration).",
  },
  es: {
    userLabel: "USUARIO",
    userName: "Ismael Manzano",
    ...
    bio3: "Disponible para proyectos remotos. Ex Full Stack Developer en Entreredes (Laravel, PHP, integración de modelos de IA).",
  },
};
